...
@push('css')
    ...
    <link rel="stylesheet" href="{{ URL::asset('./assets/css/color-02.css') }}" />
			...
			<div class=" main-content-area">
					...
					<ul class="products-cart">
						<li class="pr-cart-item">
							<div class="product-image">
								<figure><img src="{{ URL::asset('./images/products/napa.jpg') }}" width="70" height="70"  alt=""></figure>
							</div>
							<div class="product-name">
								<a class="link-to-product" href="#">Napa Tablet [500mg - 10Pcs]</a>
							</div>
							<div class="price-field produtc-price"><p class="price">$15.00</p></div>
							<div class="quantity">
							...
							<div class="price-field sub-total"><p class="price">$15.00</p></div>
							<div class="delete">
						...
						<li class="pr-cart-item">
							<div class="product-image">
								<figure><img src="{{ URL::asset('./images/products/sergel.PNG') }}" alt="" width="214" height="214" ></figure>
							</div>
							<div class="product-name">
								<a class="link-to-product" href="#">sergel Tablet [20mg - 10Pcs]</a>
							</div>
							<div class="price-field produtc-price"><p class="price">$20.00</p></div>
							<div class="quantity">
								<div class="quantity-input">
									<input type="text" name="product-quatity" value="1" data-max="120" pattern="[0-9]*">									
									<a class="btn btn-increase" href="#"></a>
							...
							<div class="price-field sub-total"><p class="price">$20.00</p></div>
							<div class="delete">
								<a href="#" class="btn btn-delete" title="">
									<span>Delete from your cart</span>
									<i class="fa fa-times-circle" aria-hidden="true"></i>
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Subtotal</span><b class="index">$35.00</b></p>
						<p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
						<p class="summary-info total-info "><span class="title">Total</span><b class="index">$35.00</b></p>
					</div>
					...
					<div class="wrap-products">
						<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="#" title="informet">
										<figure><img src="{{ URL::asset('./images/products/informet.PNG') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
									</a>
									<div class="group-flash">
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="#" title="ticamet">
										<figure><img src="{{ URL::asset('./images/products/ticamet.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
									</a>
									<div class="group-flash">
										<span class="flash-item new-label">new</span>
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="#" title="Tylenol">
										<figure><img src="{{ URL::asset('./images/products/tylenol.PNG') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
									</a>
									<div class="group-flash">
										<span class="flash-item sale-label">sale</span>
									</div>
								...
								<div class="product-info">
									...
									<div class="wrap-price"><ins><p class="product-price">$900.00</p></ins> <del><p class="product-price">$950.00</p></del></div>
								</div>
							</div>
							<br>
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									<a href="#" title="maxpro">
										<figure><img src="{{ URL::asset('./images/products/maxpro.jpg') }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
									</a>
									<div class="group-flash">
										<span class="flash-item bestseller-label">Bestseller</span>
									</div>
